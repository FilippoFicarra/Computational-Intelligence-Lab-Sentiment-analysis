...
class RobertaSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # Normalize the attention scores to probabilities. We use sparsemax instead of softmax to obtain a sparser
        # representation. The sparsemax is applied row-wise.
        attention_probs = self.sparsemax(attention_scores)
        # In the original transformer paper they use attention_probs = nn.functional.softmax(attention_scores, dim=-1)
